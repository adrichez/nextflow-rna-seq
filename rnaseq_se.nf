...
/*
#############################################################################################################################################################
    PIPELINE DE ANÁLISIS DE RNA-SEQ (LECTURAS SINGLE-END)
#############################################################################################################################################################
*/
...
include { FASTQC } from './modules/fastqc_se.nf'
include { TRIM_GALORE } from './modules/trim_galore_se.nf'
include { HISAT2_INDEX } from './modules/hisat2_index.nf'
include { HISAT2_ALIGN } from './modules/hisat2_align_se.nf'
include { FEATURECOUNTS } from './modules/featurecounts_se.nf'
...
output {
    ...
    trimming_fastqc {
        path '02_trimming/fastqc_post_trim'
        mode 'copy'
    }
